      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-center max-w-8xl w-full p-8 space-y-8 md:space-y-0 md:space-x-10">
        ...
        <div className="text-center md:text-left pl-0 lg:ml-20">
          <h1 className="text-4xl md:text-5xl font-bold text-purple-800 mb-4">
            <span className="text-blue-600"><span className="text-blue-600 text-7xl font-thin"></span></span>
           Dashboard Utilitas
          </h1>
          <button className="px-6 py-3 mt-4 text-lg font-semibold text-white bg-purple-700 rounded-3xl shadow-md hover:bg-purple-800 focus:ring focus:ring-purple-300 transition">
            Pengelolaan Air
          </button>
        </div>
